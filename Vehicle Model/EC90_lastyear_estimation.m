...
I0 = 0.490/1.5;        % no-load current (A)
w0_rpm = 2080*1.5;     % no-load speed (rpm)
...
init_accel_high=G_A_Calcs(GR,t_init_high,20.4,20.6);
hyper_accel=G_A_Calcs(GR,t_hyper,15,20.5);
...
t_coast=(21.5-19.5)/(12/85); %12 N of resistive forces at cruise
